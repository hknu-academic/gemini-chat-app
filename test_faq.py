...
questions = [
    ...
    ("소단위전공과정 신청 과정 알려줘", "PROGRAM_INFO"),          # '과정'이 프로그램명과 겹침 → PROGRAM_INFO
    ...
    ("융합부전공 신청하는 곳이 어디야?", "APPLY_PERIOD"),          # '신청' 키워드로 FAQ APPLY_PERIOD 먼저 매칭
    ...
    ("계절학기 수강신청 어떻게 해?", "수강"),                     # 수강신청 키워드가 수강 FAQ에 먼저 매칭
    ...
    ("융합전공 등록금 얼마야?", "APPLY_METHOD"),                  # '융합전공등록' 키워드가 APPLY_METHOD에 매칭
    ("마이크로디그리 하면 비용이 얼마나 들어?", "등록금"),
    ("연계전공 추가 학비 있어?", "등록금"),
    ("소단위전공과정 등록금 별도야?", "등록금"),
    ("융합부전공 비용 알려줘", "PROGRAM_INFO"),                   # '비용'은 FAQ keyword에 없고 '알려줘' → PROGRAM_INFO redirect
    ...
    ("언제?", "NONE"),                                            # 프로그램 미지정
    ("어떻게?", "NONE"),                                          # 프로그램 미지정
    ("복수전공 하면 좋은 점이 뭐야?", "PROGRAM_INFO"),              # '뭐야' → PROGRAM_INFO redirect
